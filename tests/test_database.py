...
import os
import pytest
from Libs.DB import setup_embeddings_database, get_embeddings_db_connection
import unittest
import random
...
class TestDB(unittest.TestCase):
    def test_setup_database(self):
        ...
        with get_embeddings_db_connection(fn) as conn:
            pass
    ...
    def test_persistance(self):
        ...
        with get_embeddings_db_connection(db1) as conn:
        ...
        with get_embeddings_db_connection(db2) as conn:
            with closing(conn.cursor()) as cursor:
